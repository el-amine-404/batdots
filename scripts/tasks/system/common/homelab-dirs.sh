...
hldirs::create_service_directories() {
  ...
  local dirs=(
    ...
    "${CONFIGS_ROOT}/homepage/config" "${VOLUMES_ROOT}/homepage/icons" "${VOLUMES_ROOT}/homepage/images" "${VOLUMES_ROOT}/homepage/logs"
    "${CONFIGS_ROOT}/filebrowser/conf" "${VOLUMES_ROOT}/filebrowser"
    "${VOLUMES_ROOT}/portainer"
    "${CONFIGS_ROOT}/jellyfin/config" "${VOLUMES_ROOT}/jellyfin/cache" "${VOLUMES_ROOT}/jellyfin/data" "${VOLUMES_ROOT}/jellyfin/log"
